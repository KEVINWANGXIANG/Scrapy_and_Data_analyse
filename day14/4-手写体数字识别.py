...
'''
im = Image.open(r'C:/Users/Administrator/Desktop/weixin.png')
fh = open(r'C:/Users/Administrator/Desktop/weixin.txt', "a")
# im.save("path")
width = im.size[0]
height = im.size[1]
print(width, height)
...
file = 'C:/Users/Administrator/Desktop/digits/digits/testdata/8_12.txt'
singleFileTest(file)
'''
